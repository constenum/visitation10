...
<div class="font-sans text-gray-900 antialiased">
            ...
            <table id="students" class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                ...
                @forelse($students as $student)
                    <tr  x-show="school == {{ $student->school_id }}" x-cloak class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                        <td class="px-6 py-4">
                            <a href="{{ route('student.edit', $student->id) }}" class="font-medium text-blue-700 hover:underline">Check In</a>
                        </td>
    ...
    <footer class="mt-16 mb-6 text-center text-sm text-gray-400">&copy; 2023 St. Ursula Academy</footer>
</div>
</body>
</html>
