...
<div class="font-sans text-gray-900 antialiased">
    ...
    <div class="mt-16 ml-96 mr-96 text-center">
        <form method="POST" action="/student/{{ $student->id }}">
            ...
            <button type="submit" class="mt-4 rounded-md bg-blue-600 px-6 py-3 text-sm font-semibold text-white shadow-sm hover:bg-blue-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600">Check In</button>
        </form>
    </div>
